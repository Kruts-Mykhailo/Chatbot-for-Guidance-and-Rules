...
from app.dependencies import get_model, get_vector_search, get_embedding_generator
...
async def chat(
    ...
    try:
        ...
        chatbot_response = rag_pipeline([user_query], vector_search, embedding_generator, model)
