...
def parse_args():
    ...
    parser.add_argument("--search_type", type=str, required=True, help="Type of vector search (e.g., pgvector)")
    parser.add_argument("--generator_type", type=str, required=True, help="Type of embedding generator (e.g., sentence_transformer)")
    parser.add_argument("--model_type", type=str, required=True, help="Type of model for RAG (e.g., ollama)")
